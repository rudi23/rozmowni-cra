...
function getGroupCourse(canonicalUrl) {
    ...
    const description =
        'Grupowe lekcje angielskiego online. Szeroki wybór kursów tematycznych: konwersacje, General English, przygotowanie do egzaminu (ósmoklasisty, maturalnego, Cambridge), Business English. Różne poziomy zaawansowania: A2, B1, B2, C1, C2.';
...
function getContact(canonicalUrl) {
    ...
    return {
        ...
        description,
        robots: 'index, follow',
        jsonLd: [getWebPageJsonLd(canonicalUrl), getBreadcrumbsJsonLd('Konktakt', canonicalUrl)],
    };
}
